...
---
title: Create Cross-Chain Smart Accounts | Biconomy Integration Guide
description: Learn how to integrate Biconomy Smart Accounts that maintain the same address across all chains. This guide covers deterministic account creation with CREATE2, installation steps, and code examples, enabling you to implement account abstraction with minimal configuration. 
---
# Integration
